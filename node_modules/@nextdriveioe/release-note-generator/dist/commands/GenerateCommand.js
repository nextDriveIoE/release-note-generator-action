...
class GenerateCommand {
    ...
    builder(args) {
        return args
            ...
            alias: "deepBaseFrom",
            demandOption: false,
            describe: "tag or commit sha for base from"
        });
    }
    async handler(args) {
        if (args.config) {
        ...
        if (args.deepPackages && args.deepRepos && args.deepLabels) {
            ...
            diffVersions = diffVersionService.getVersions(compares, args.packagePath, args.deepPackages.split(","), args.deepRepos.split(","), args.deepLabels.split(","), args.deepPrefix.split(","), (args.deepBaseFrom || "").split(","));
