...
class DiffVersionService {
    ...
    getVersions(res, packagePath, deepPackages, repos, labels, tagPrefix, baseFrom) {
        ...
        return deepPackages
            ...
            let [from, to] = parsePackageDiff_1.parsePackageDiff(packageName, diffFile.patch);
            from = from ? `${prefix}${from}` : (to ? baseFrom[index] : ``);
            return {
